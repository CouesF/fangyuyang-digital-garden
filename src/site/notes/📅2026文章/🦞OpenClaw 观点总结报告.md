...
**OpenClaw是什么**: 一个开源的、自托管的个人AI助手，由Peter Steinberger开发，可以在用户自己的设备上运行，通过WhatsApp、Telegram、Slack、Discord等消息平台与用户交互，具备自主执行任务的能力。

> 本报告基于Claude Code + GLM-5 + Playwright构建
